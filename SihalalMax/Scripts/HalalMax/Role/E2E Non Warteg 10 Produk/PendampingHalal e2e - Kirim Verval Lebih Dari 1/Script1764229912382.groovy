...
println("ID diterima dari GlobalVariable: " + idPengajuan)

if (idPengajuan == null || idPengajuan.trim().isEmpty()) {
	KeywordUtil.markFailed("ID Pengajuan kosong! Flow Pelaku gagal.")
}
...
String lihatButtonXpath =
"//tr[.//p[normalize-space()='" + idPengajuan + "']]//div[h1[normalize-space()='Lihat']]"
