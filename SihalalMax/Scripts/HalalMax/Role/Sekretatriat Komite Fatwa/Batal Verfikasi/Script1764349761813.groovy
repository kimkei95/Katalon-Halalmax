...
WebUI.click(findTestObject('Halalmax/Sekretariat Komite Fatwa/Dropdown Daftar Komite Fatwa'))

WebUI.click(findTestObject('Halalmax/Sekretariat Komite Fatwa/Kirim Verifikasi/Pilih Komite Fatwa'))

WebUI.delay(2)

WebUI.click(findTestObject('Halalmax/Sekretariat Komite Fatwa/Kirim Verifikasi/Button Kirim Verifikasi'))

WebUI.delay(2)

WebUI.click(findTestObject('Halalmax/Sekretariat Komite Fatwa/Kirim Verifikasi/Button (Tidak) untuk kirim verifikasi'))
