...
WebUI.click(findTestObject('Halalmax/Sekretariat Komite Fatwa/Tolak Pengajuan/Button Tolak Pengajuan (SKF)'))

WebUI.delay(2)

WebUI.click(findTestObject('Halalmax/Sekretariat Komite Fatwa/Tolak Pengajuan/Dropdown Alasan Penolakan (SKF)'))

WebUI.delay(2)

WebUI.click(findTestObject('Halalmax/Sekretariat Komite Fatwa/Tolak Pengajuan/Alasan Penolakan'))
...
WebUI.click(findTestObject('Halalmax/Sekretariat Komite Fatwa/Tolak Pengajuan/Button Lanjutkankan Penolakan (SKF)'))
