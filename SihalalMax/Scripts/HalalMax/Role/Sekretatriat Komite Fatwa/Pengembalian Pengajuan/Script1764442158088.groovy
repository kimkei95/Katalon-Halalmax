...
WebUI.click(findTestObject('Halalmax/Sekretariat Komite Fatwa/Pengembalian/Button Pengembalian Pengajuan'))
...
WebUI.click(findTestObject('Halalmax/Sekretariat Komite Fatwa/Pengembalian/Button Lanjutkan Pengembalian'))
