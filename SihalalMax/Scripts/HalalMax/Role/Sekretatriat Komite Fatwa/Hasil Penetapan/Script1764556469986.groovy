...
WebUI.click(findTestObject('Halalmax/Sekretariat Komite Fatwa/Hasil Penetapan/Dropdown Self Declare'))

WebUI.delay(2)

WebUI.click(findTestObject('Halalmax/Sekretariat Komite Fatwa/Hasil Penetapan/Button Hasil Penetapan'))
...
WebUI.click(findTestObject('Halalmax/Sekretariat Komite Fatwa/Button kembali'))
