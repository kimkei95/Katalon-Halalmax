...
WebUI.click(findTestObject('HalalMax/LP3H/Filter pengajuan/SidebarData'))

WebUI.delay(3)

WebUI.click(findTestObject('HalalMax/LP3H/Filter pengajuan/SubmenuDataPelakuUsaha'))

WebUI.delay(5)

WebUI.click(findTestObject('HalalMax/LP3H/Filter pengajuan/Filter'))

WebUI.delay(3)

WebUI.click(findTestObject('HalalMax/LP3H/Filter pengajuan/PilihProvinsi'))

WebUI.delay(3)

WebUI.click(findTestObject('HalalMax/LP3H/Filter pengajuan/Banten'))

WebUI.delay(3)

WebUI.click(findTestObject('HalalMax/LP3H/Filter pengajuan/PilihKotaKabupaten'))

WebUI.delay(3)

WebUI.click(findTestObject('HalalMax/LP3H/Filter pengajuan/Tangsel'))

WebUI.delay(3)

WebUI.click(findTestObject('HalalMax/LP3H/Filter pengajuan/Terapkan'))
