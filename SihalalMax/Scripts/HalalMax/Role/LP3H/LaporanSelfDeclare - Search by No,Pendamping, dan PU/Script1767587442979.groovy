...
WebUI.click(findTestObject('HalalMax/LP3H/Laporan SelfDeclare/SidebarLaporan'))

WebUI.delay(3)

WebUI.click(findTestObject('HalalMax/LP3H/Laporan SelfDeclare/Sidemenu SelfDeclare'))

WebUI.delay(5)

WebUI.click(findTestObject('HalalMax/LP3H/Laporan SelfDeclare/FieldSearch'))

WebUI.delay(3)

def names = ['3723', '3713', '3712', '3708', '3703', 'MIRA SETIAWAN', 'UMMI MANURUNG', 'NURKHOLIS', 'ASHAR ADE PUTRA', 'UNAH'
    , 'Abiyyu Achmad Syahru Mubarok', 'Adi Kuasa Permana', 'Bachtiar Akmal', 'Achmad Ichsan Nusapati']

def randomName = names[new Random().nextInt(names.size())]

WebUI.setText(findTestObject('HalalMax/LP3H/Laporan SelfDeclare/FieldSearch'), randomName)

println('Nama yang dipakai: ' + randomName)

WebUI.delay(3)

WebUI.click(findTestObject('HalalMax/LP3H/Laporan SelfDeclare/btnSearch'))
