...
WebUI.click(findTestObject('HalalMax/LP3H/Cari Pelaku Usaha/FieldSearch'))

WebUI.delay(3)

def names = ['INDAR LIANI', 'UNAH', 'ASHAR ADE PUTRA', 'MIRA SETIAWAN', 'UMMI MANURUNG', 'NURKHOLIS']

def randomName = names[new Random().nextInt(names.size())]

WebUI.setText(findTestObject('HalalMax/LP3H/Cari Pelaku Usaha/FieldSearch'), randomName)

println('Nama yang dipakai: ' + randomName)

WebUI.click(findTestObject('HalalMax/LP3H/Cari Pelaku Usaha/Icon Search'))
