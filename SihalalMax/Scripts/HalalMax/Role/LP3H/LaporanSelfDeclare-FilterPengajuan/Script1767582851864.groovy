...
WebUI.click(findTestObject('HalalMax/LP3H/Laporan SelfDeclare/Filter'))

WebUI.delay(3)

WebUI.click(findTestObject('HalalMax/LP3H/Laporan SelfDeclare/Pilih Jenis Fasilitasi'))

WebUI.delay(3)

WebUI.click(findTestObject('HalalMax/LP3H/Laporan SelfDeclare/Sehati'))

WebUI.delay(3)

WebUI.click(findTestObject('HalalMax/LP3H/Laporan SelfDeclare/Terapkan'))
