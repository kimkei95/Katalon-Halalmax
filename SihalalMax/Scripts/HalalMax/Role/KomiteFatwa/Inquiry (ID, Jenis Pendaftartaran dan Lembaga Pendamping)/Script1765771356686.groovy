...
WebUI.click(findTestObject('HalalMax/Komite Fatwa/Inquiry/Field Nomor ID'))

WebUI.setText(findTestObject('HalalMax/Komite Fatwa/Inquiry/Field Nomor ID'), '3467')

WebUI.delay(2)

WebUI.click(findTestObject('HalalMax/Komite Fatwa/Inquiry/Dropdown Jenis Pendaftaran'))

WebUI.delay(2)

WebUI.click(findTestObject('HalalMax/Komite Fatwa/Inquiry/Jenis Pendaftaran(Baru)'))

WebUI.delay(2)

WebUI.click(findTestObject('HalalMax/Komite Fatwa/Inquiry/Dropdown Lembaga Pendamping'))

WebUI.delay(3)

WebUI.click(findTestObject('HalalMax/Komite Fatwa/Inquiry/Lembaga Pendamping (Mathlaul Anwar)'))
