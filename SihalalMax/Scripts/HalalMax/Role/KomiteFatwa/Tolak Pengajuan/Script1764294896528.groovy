...
WebUI.click(findTestObject('Halalmax/Komite Fatwa/Penolakan KF/Button Tolak Pengajuan (KF)'))

WebUI.delay(2)

WebUI.click(findTestObject('Halalmax/Komite Fatwa/Penolakan KF/Dropdown Alasan Penolak (KF)'))
...
WebUI.click(findTestObject('Halalmax/Komite Fatwa/Penolakan KF/Button Lanjutkan Penolakan (KF)'))
