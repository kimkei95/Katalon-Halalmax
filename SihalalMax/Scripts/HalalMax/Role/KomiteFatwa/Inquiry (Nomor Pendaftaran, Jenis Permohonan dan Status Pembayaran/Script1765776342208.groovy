...
WebUI.setText(findTestObject('HalalMax/Komite Fatwa/Inquiry/Field Nomor Pendaftaran'), 'SH2025-1-623403')

WebUI.delay(2)

WebUI.click(findTestObject('HalalMax/Komite Fatwa/Inquiry/Dropdown Jenis Permohonan'))

WebUI.delay(2)

WebUI.click(findTestObject('HalalMax/Komite Fatwa/Inquiry/Jenis Permohonan (Pendaftaran Self Declare Fasilitasi)'))

WebUI.delay(2)

WebUI.click(findTestObject('HalalMax/Komite Fatwa/Inquiry/Dropdown Status Pembayaran'))

WebUI.delay(3)

WebUI.click(findTestObject('HalalMax/Komite Fatwa/Inquiry/Status Pembayaran (Lunas)'))
